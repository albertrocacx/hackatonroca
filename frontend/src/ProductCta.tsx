import type { PriceType, ShopItem } from "./api";

// CTA de compra según el tipo de precio del producto:
//   OnlineFrom -> "Comprar online" (añade al carrito)
//   PVPR       -> "Donde comprar"  (abre el buscador de distribuidores)
// La UI es del colega; aquí quedan cableados los handlers downstream.
export default function ProductCta({
  priceType, item, onBuyOnline, onFindLocal,
}: {
  priceType: PriceType;
  item?: ShopItem;
    ...
    return (
      <div className="rs-cta-row">
        <button
          ...
          onClick={(e) => { e.stopPropagation(); if (item) onBuyOnline?.(item); }}
        >
  ...
  return (
    <div className="rs-cta-row">
      <button
        ...
        onClick={(e) => { e.stopPropagation(); if (item) onFindLocal?.(item); }}
      >
        Donde comprar
